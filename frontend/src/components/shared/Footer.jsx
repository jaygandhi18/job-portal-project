...
const Footer = () => {
  return (
    <footer className="bg-[#111827] border-t border-[#1E293B] py-8 text-[#F8FAFC]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          
          {/* Brand & Copyright */}
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h2 className="text-xl font-bold text-[#3B82F6]">JobCrate</h2>
            <p className="text-sm text-[#F8FAFC]/80">
              © 2025 JobCrate. All rights reserved.
            </p>
          </div>
